...
\begin{frame}[b]{Pitch}
  \begin{itemize}
    \item \parbox{0.60\textwidth}{\textbf{NitrusLeaf}: Cuidando da sua plantação!
  }
  \end{itemize}
...
\usebackgroundtemplate{%
  ...
  \begin{itemize}
      \item Registro de alta incidência de\\ greening (>60\%) na citricultura paulista.
      \vspace{0.3cm}
      \item Sintomas do greening são semelhantes a \\deficiências nutricionais, dificultando o \\diagnóstico.
      \vspace{0.3cm}
      \item Essa confusão pode gerar perdas \\ no manejo das lavouras.
      \vspace{0.3cm}
      \item Pequenos produtores têm acesso limitado\\ a ferramentas de diagnóstico.
  \end{itemize}
    
  \vfill
  
  {\fontsize{4}{5}\selectfont\textit{Fonte:  Fundecitrus, Araraquara, São Paulo 2025}\hfill\textcolor{white}{Imagem: Percentual das laranjeiras com greening por setor e região}}
\end{frame}
}
...
\begin{frame}[b]{Objetivo}
  \begin{itemize}
    \item \parbox{0.60\textwidth}{\textbf{Objetivo geral}: Desenvolver o \textbf{NitrusLeaf}, para identificar \\deficiência nutricional de manganês ou cobre em folhas de \\mexerica com IA.}
    \vspace{0.3cm}
  ...
  {\fontsize{4}{5}\selectfont\textit{Fonte: Autoria Própria}\hfill\textcolor{white}{Imagem: Símbolo IA e mexerica}}
\end{frame}
}
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight]{imgs/Ferramental.png}%
}
\begin{frame}[b]{Ferramental}
  ...
  {\fontsize{4}{5}\selectfont\textit{Fonte: Autoria Própria}\hfill\textcolor{white}{Imagem: Logos das tecnologias utilizadas}}
\end{frame}
}
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight]{imgs/ApresentacaoPratica.png}%
}
\begin{frame}[b]{Apresentação Prática}
  \begin{itemize}
    \item Captura da imagem da folha pelo aplicativo
    \item Envio da imagem para a API de processamento
    \item Processamento pela rede neural (CNN)
    \item Retorno do diagnóstico em tempo real
    \item Visualização do resultado no aplicativo
  \end{itemize}
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight]{imgs/ResultadosDiscussoes.png}%
}
\begin{frame}[b]{Resultados e Discussões}
  \begin{itemize}
    \item \parbox{0.60\textwidth}{\textbf{Resultados Técnicos da IA e Discussão}: \\Acurácia de 95,97\% no modelo treinado, eficiente \\mesmo com poucos dados.}
    \vspace{0.3cm}
    \item \parbox{0.60\textwidth}{\textbf{Limitações e Escopo do Projeto}: \\Baixo volume de dados, foco apenas na \\deficiência de manganês.}
    \vspace{0.3cm}
    \item \parbox{0.60\textwidth}{\textbf{Trabalhos Futuros}: \\Incluir deficiência de cobre no Escopo, tornar o \\sistema multiclasse e avaliação de arquiteturas \\pré-treinadas como ResNet e MobileNet.}
  \end{itemize}
  
  \vfill
  
  {\fontsize{4}{5}\selectfont\textit{Fonte: Autoria Própria}\hfill\textcolor{white}{Imagem:  Desempenho do modelo de classificação das folhas de mexerica}}
\end{frame}
}
