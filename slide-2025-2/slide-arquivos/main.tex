...
\small
\begin{itemize}
    \item Requisitos e Prototipação no Figma.
    \item Pesquisa de campo e coleta inicial de imagens.
    \item Classificação preliminar com CNNs e transfer learning.
    \item Desenvolvimento da aplicação Web e Mobile.
...
\vspace{0.1cm}
\centering Aplicação Web e Mobile

\includegraphics[width=10cm]{img/aplicacao-pratica.png}
...
\begin{itemize}
    \item[] \textbf{Pesquisa de campo}
    \item A pesquisa com produtores de \textit{Citrus reticulata} em Pariquera-Açu mostrou que deficiências de manganês e cobre são facilmente confundidas com Greening, evidenciando a importância do projeto.

    \vspace{0.2cm}

    \item[] \textbf{Projeto}
    \item Refinamento do protótipo e da aplicação Web com banco de dados
    \item Criação do aplicativo mobile.
    
    \vspace{0.2cm}

    \item[] \textbf{Próximos passos:}
    \item Ampliar o banco de dados e implementar IA.
...
\begin{itemize}
    \item \textbf{Desenvolvimento:} Estrutura das aplicações (Web e Mobile)
    
    \vspace{0.5cm}
    \item O projeto NitrusLeaf demonstrou potencial como ferramenta prática e acessível para diagnóstico nutricional.
    \item Utilizará IA para identificar deficiências de manganês e cobre em folhas de mexerica, garantindo rapidez e precisão.
    \item Contribui para a sustentabilidade agrícola ao reduzir custos e perdas na produção.
\end{itemize}
