...
da Mexerica, Orientado por Redes Neurais}}\\[0.7cm]
    {\normalsize Amanda Freitas, Lucas Fagundes, Valéria de Freitas}\\[0.1cm]
    \textcolor{cpsgray}{Mentor Prof. Diego Max Da Silva}\\
    \textcolor{cpsgray}{Orientador Prof. MSc. Frederico Barbosa Muniz}\\[0.2cm]
    \textcolor{cpsgray}{Centro Paula Souza}\\
    \textcolor{cpsgray}{FATEC Registro}\\[0.2cm]
\end{frame}
...
\centering{\textbf{Pesquisa de Campo}}

\vspace{1mm}
\begin{center}
\includegraphics[width=0.58\linewidth]{img/Pesquisa-de-campo.jpg}

\vspace{1mm}
{\footnotesize Figura 2 – Plantação de Citrus reticulata afetada por sintomas visuais, sinalizada por uma fita.\\Fonte: Autoria própria, 2025}
\end{center}
...
\small
\begin{itemize}
  \item \textbf{Etapas ágeis}: levantamento de requisitos e protótipos no Figma.
  \item \textbf{Imagens}: captura via celular e pré-processamento das folhas.
  \item \textbf{Modelo}: Classificação com redes neurais convolucionais (CNN) em Python;
  \item \textbf{Sistema}: app em React/Next.js + API em Node.js.
  \item \textbf{Dados}: diagnósticos registrados e monitorados em MySQL.
  \item \textbf{Treino}: cerca de 1.500 imagens anotadas para ajuste do modelo.
\end{itemize}
...
\begin{itemize}
    \item A pesquisa de campo com produtores de \textit{Citrus reticulata} em Pariquera-Açu mostrou que as deficiências de manganês e cobre ainda são identificadas tardiamente e frequentemente confundidas com sintomas de Greening.
    \item A ferramenta proposta oferece um diagnóstico nutricional rápido e acessível para pequenos e médios produtores, contribuindo para reduzir custos, desperdícios e a dependência de análises manuais, além de favorecer uma agricultura mais sustentável.
\end{itemize}
...
\begin{itemize}
    \item NitrusLeaf mostrou ser uma ferramenta prática potencial para diagnóstico nutricional com IA.\\
    \item Propõe identificar rapidamente deficiências de manganês e cobre em folhas de mexerica.\\
    \item Reduz custos, perdas e melhora a sustentabilidade agrícola.\\
    \item Próximos passos: ampliar dados, aprimorar o modelo e expandir para outras culturas.
\end{itemize}
